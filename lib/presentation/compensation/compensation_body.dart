                  ...
                  child: Card(
                    ...
                    child: Padding(
                      ...
                      child: LiveChartWidget(
                        axes: [
                          LiveAxis(
                            stream: _dsClient.streamReal('Platform.SensorMRU'),
                            signalName: 'Platform.SensorMRU', 
                            caption: const Localized('Sensor MRU').v,
                            color: Colors.lightGreenAccent,
                            bufferLength: 3000,
                          ),
                          LiveAxis(
                            stream: _dsClient.streamReal('Hook.Speed'),
                            signalName: 'Hook.Speed',
                            caption: const Localized('Hook speed').v, 
                            color: Colors.blue,
                            bufferLength: 3000,
                          ),
                        ],
